...
export const UserSchema = new Schema(
  {
    ...
    phone: {
      type: String,
      required: [true, ValidationMessage.requiredMessage('user-phone-number')],
      validate: [
        phoneValidator,
        ValidationMessage.patternMessage('user-phone-number'),
      ],
      minlenght: [
        PHONE_LENGHT,
        ValidationMessage.minLenghtMesage('user-phone-number', PHONE_LENGHT),
      ],
      maxlenght: [
        PHONE_LENGHT,
        ValidationMessage.maxLenghtMesage('user-phone-number', PHONE_LENGHT),
      ],
      alias: 'user_phone_number',
    },
    password: {
      type: String,
